...
WANNABE_VERSION := WannabeOS-$(WANNABEVERSION)-$(WANNABEVERNAME)-$(WANNABE_BUILD)-$(WANNABE_BUILD_DATE)-$(WANNABE_BUILD_TYPE)-$(WANNABE_BUILD_ZIP_TYPE)
WANNABE_DISPLAY_VERSION := WannabeOS-$(WANNABEVERSION)-$(WANNABEVERNAME)
WANNABE_FIRMWARE_INFO := $(WANNABEVERSION)-$(WANNABEVERNAME)
...
PRODUCT_SYSTEM_DEFAULT_PROPERTIES += \
  ...
  ro.WANNABE.firmwareinfo=$(WANNABE_FIRMWARE_INFO) \
