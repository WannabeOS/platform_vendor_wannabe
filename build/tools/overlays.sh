...
cur_dir=`pwd`
flashable_zip_template="$ANDROID_BUILD_TOP/vendor/wannabe/build/tools/overlays_zip_template"
overlays_path_top="$ANDROID_BUILD_TOP/vendor/wannabe/overlay/themes/"
